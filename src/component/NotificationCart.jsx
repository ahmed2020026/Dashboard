        ...
        <div className="bg-white p-4 shadow-lg rounded-2xl w-64">
            ...
            <div className="space-y-2">
                <div className="p-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition cursor-pointer">
                    <p className="text-sm text-gray-700">🔔 New user signed up</p>
                    <span className="text-xs text-gray-500">2 min ago</span>
                </div>

                <div className="p-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition cursor-pointer">
                    <p className="text-sm text-gray-700">📩 You have 3 new messages</p>
                    <span className="text-xs text-gray-500">10 min ago</span>
                </div>

                <div className="p-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition cursor-pointer">
                    <p className="text-sm text-gray-700">⚡ Server restarted</p>
